        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->
                  <hr/>
                 <?php echo form_open_multipart('apotik/createSupplier'); ?>
                ...
                <?php echo validation_errors(); ?>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Nama Supplier" name="nama_sup"/>
                                       </div>
                                        
                                        <div class="form-group">
                                            <label>Perusahaan</label>
                                            <input class="form-control" placeholder="Perusahaan" name="perusahaan" />
                                        </div>
