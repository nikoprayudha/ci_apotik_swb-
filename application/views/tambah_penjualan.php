                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-responsive" id="pelanggantampil">
                                    <thead>
                                        <tr>
                                            <th>Id Pelanggan</th>
...
<!-- ______________________________________________________________________________ -->           
                  <hr/>
                 <?php echo form_open_multipart('apotik/createPenjualan'); ?>
                ...
                <?php echo validation_errors(); ?>
                                         ...
                                         <div class="form-group">
                                           ...
                                           <select class="form-control" name="idPlg">
                                              <option>---pilih pelanggan-----</option>
                                               <?php foreach($plg->result() as $pel) { ?>
                                                 <option><?php echo $pel->idPlg ?></option>
                                               <?php } ?>
                                           </select>
                                       </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="tgl_pnj">
                                        </div>
...
<script type="text/javascript">
        $(document).ready(function() {
            $('#obatampil').DataTable({
                ...
                "ajax":{
                    url : "<?php echo site_url('apotik/data_view_obat')?>",
                    type: "POST"
                },
                "columnDefs":
                [
...
<!-- ____________________________________________________________________________________ -->
  ...
  <script type="text/javascript">
        $(document).ready(function() {
            $('#pelanggantampil').DataTable({
                "processing":true,
                "serverSide":true,
                "lenghtMenu":[[1,3,6,-1],[1,3,6,"All"]],
                "ajax":{
                    url : "<?php echo site_url('apotik/data_view_pelanggan')?>",
                    type: "POST"
                },
                "columnDefs":
                [
...
<script type="text/javascript">
        $(document).ready(function() {
            $('#pegawaitampil').DataTable({
                ...
                "lenghtMenu":[[1,3,6,-1],[1,3,6,"All"]],
                "ajax":{
                    url : "<?php echo site_url('apotik/data_view_pegawai')?>",
                    type: "POST"
                },
                "columnDefs":
                [   
