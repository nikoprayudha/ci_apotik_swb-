<?php $this->load->view('header');?>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    <!-- Advanced Tables -->
                     <a href="<?=base_url()?>index.php/apotik/createObat"><button type="button" class="btn btn-success btn-circle">Create <i class="fa fa-plus"></i></button></a>
                      <a href="<?=site_url()?>/cetak/viewObat"><button type="button" class="btn btn-danger btn-circle">Print <i class="fa fa-print"></i></button></a>
                      <br>
                      <br>     
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-responsive" id="obattabel">
                                    <thead>
                                        <tr>
                                            <th>Id Obat</th>
                                            <th>Nama Obat</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#obattabel').DataTable({
                ...
                "ajax":{
                    url : "<?php echo site_url('apotik/data_server_obat')?>",
                    type: "POST"
                },
                "columnDefs":
                [
                    ...
                    },
                    {
                        ...
                        return '<a href="<?=site_url()?>/apotik/updateObat/'+data["idObat"]+'"><button class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-pencil"></span></button></a>';
                    }
                    },
                    {
                        "targets":6,
                        ...
                        "searchable":false,
                        "render":function(data,type,full,meta){
                        return '<a href="<?=site_url()?>/apotik/deleteObat/'+data["idObat"]+'"><button class="btn btn-danger btn-xs" onClick="return doconfirm();" ><span class="glyphicon glyphicon-trash"></span></button></a>';
                    }
                    },
                ]
            });
