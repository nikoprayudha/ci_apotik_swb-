<?php $this->load->view('header');?>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <?php echo form_open_multipart('apotik/updatePelanggan/'.$this->uri->segment(3)); ?>
                                        <div class="form-group">
                                            <label>Nama Pelanggan</label>
                                            <input class="form-control" value="<?php echo $pelanggan[0]->nama_plg?>" name="nama_plg"/>
                                       </div>
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="jk" value="Laki-Laki" <?php if( $pelanggan[0]->jk == "Laki-Laki" ) echo "checked"; ?> />Laki-Laki
                                                </label>
                                                <label>
                                                    <input type="radio" name="jk" value="Perempuan" <?php if( $pelanggan[0]->jk == "Perempuan" ) echo "checked"; ?> />Perempuan
                                                </label>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="form-group">
                                            <label>Alamat</label>
                                           <textarea class="form-control"  name="alamat" id="alamat" cols="10" rows="10"><?php echo $pelanggan[0]->alamat?></textarea>
                                        </div>
            
                                         <div class="form-group">
                                            <label>telp</label>
                                            <input class="form-control" value="<?php echo $pelanggan[0]->telp?>" name="telp" />
                                        </div>
