        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->
                  <hr/>
                 <?php echo form_open_multipart('apotik/createObat'); ?>
                ...
                <?php echo validation_errors(); ?>
                                        <div class="form-group">
                                            <label>Id Obat</label>
                                            <input class="form-control" placeholder="Id Obat" name="idObat"/>
                                       </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label>Harga</label>
                                            <input class="form-control" placeholder="0000000" name="harga" />
                                        </div>
